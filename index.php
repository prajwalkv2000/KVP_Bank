...
<head>
  ...
  <title>Welcome to KVP Bank</title>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- Uncomment below if you prefer to use an text logo -->
         <h1><a href="index.php">KVP BANK</a></h1> 
        <!--<a href="index.php"><img src="./assets/img/favicon.png" alt="Logo" class="img-fluid"><b>&nbsp;&nbsp;KVP BANK</b></a>-->
      </div>
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Welcome to the<br><span>KVP Bank</span><br>Services!</h2>
        <div>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>KVP is an Indian multinational, public sector banking and financial services statutory body, fostering the nation’s 2.6 trillion-dollar economy and serving the hopes of its vast population.</p>
        </header>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p>
              For KVP, the interests of the common man havealways remained at the core of its business.With a customer-centric approach, the Bankhas designed products and services to meet the expectations of the financial life cycle of its valued clientele. Keeping pace with the transforming landscape of the Indian economy, KVP has broadened its digital base in the recent years. 
            </p>
    ...
    <section id="services" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Notice</h3>
          <p>Here are some latest updates from KVP Bank. Read this notices carefully</p>
        </header>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              ...
              <p class="description">  Dear Customer, if you have donated for PM CARES through KVP Internet Banking, you can download the Receipt from PMCares portal of govt. using the reference number available with you. </p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              ...
              <h4 class="title"><a href="">KVP BANKING</a></h4>
              <p class="description"> Have you tried our new simplified and intuitive business banking platform? Log in to KVPbank to avail business banking services</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
...
-->
        ...
        <div class="row row-eq-height justify-content-center">
          ...
          <div class="col-lg-4 mb-4">
            <div class="card" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="card-body">
                <h5 class="card-title">KVP Bank Card</h5>
                <p class="card-text">20% discount of Flipart products.Pay using KVP Bank card.</p>
                <a href="#" class="readmore">Read more </a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="map mb-4 mb-lg-0">
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7959.597388636154!2d75.38753387010752!3d13.57112644453732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1632048438640!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-md-5 info">
                ...
                <p>Kesave, Koppa-577126</p>
              </div>
              <div class="col-md-4 info">
                <i class="bi bi-envelope"></i>
                <p>kvprajwal2000@gmail.com</p>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2021 Copyright <strong>Prajwal K V</strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
